      ...
      <div className="max-w-[1400px] mx-auto px-4 py-24">
        {loading ? (
          ...
          <div className="text-center py-20 border border-dashed border-neutral-200">
             <p className="text-neutral-400 font-mono text-sm uppercase tracking-widest">No collection found in this category.</p>
          </div>
        ) : (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-10 gap-y-24">
            {products.map((product) => (
              <div key={product._id} className="group flex flex-col items-center">
                ...
                {/* Product Caption (Minimalist like Screenshot) */}
