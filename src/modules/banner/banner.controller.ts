...
const getSingleBanner = async (
  ...
  return sendResponse({ statusCode: 200, success: true, message: "Banner fetched", data: result });
};
...
const updateBanner = async (
  ...
  return sendResponse({ statusCode: 200, success: true, message: "Banner updated", data: result });
};
...
const deleteBanner = async (
  ...
  return sendResponse({ statusCode: 200, success: true, message: "Banner deleted", data: result });
};
